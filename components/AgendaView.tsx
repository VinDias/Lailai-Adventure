...
const AgendaView: React.FC<AgendaViewProps> = ({ open, onClose, onOpenSeries }) => {
  ...
  return (
    <div className="fixed inset-0 z-[1500] bg-[var(--bg-color)] animate-apple overflow-y-auto pb-40 scrollbar-hide">
      ...
      {!loading && error && (
        <div className="py-20 px-8 text-center">
          <p className="text-zinc-600 font-bold uppercase tracking-widest text-xs">{t('auth.errorGeneric')}</p>
        </div>
      )}
